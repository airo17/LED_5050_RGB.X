...
# 51 "./mcc_generated_files/examples/i2c_master_example.h"
...
void power_on_BH1750(void){
    uint8_t comand = 0b00000001;

    I2C_WriteNBytes(0x0023, 0b00000001, 1);
}

void continuously_H_resolution_Mode2_BH1750(void){
    uint8_t comand = 0b00010001;

    I2C_WriteNBytes(0x0023, 0b00010001, 1);
}

uint16_t read_result_BH1750(void){
    uint8_t result[2] = {0};

    I2C_ReadNBytes(0x0023, &result[0], 2);
