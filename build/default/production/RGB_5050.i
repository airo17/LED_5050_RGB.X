...
void set_led_color(uint8_t number_led, uint8_t red, uint8_t green, uint8_t blue){
    ...
    for(uint8_t number_led_choose = 1; number_led_choose <= number_led; number_led_choose++){
        for(uint8_t i = 0; i != 8; i++){
            if(green & (0b00000001 << i)){
                LATBbits.LATB5 = 1;LATBbits.LATB5 = 1;LATBbits.LATB5 = 1;LATBbits.LATB5 = 0;
            }
            else{
                LATBbits.LATB5 = 1;LATBbits.LATB5 = 0;LATBbits.LATB5 = 0;LATBbits.LATB5 = 0;
            }
        }
    ...
    LATBbits.LATB5 = 1;LATBbits.LATB5 = 0;_delay((unsigned long)((200)*(32000000/4000.0)));
}
